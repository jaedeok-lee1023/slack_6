...
def main():
    for cluster in clusters:
        ...
        notice_msg = (
            ...
            f":k체크: *위생관리를 위해 매주 금요일 오전 11시 점검을 진행 합니다.*\n"
            f":k체크: *냉장고 내부 스티커를 부착 된 상품의 경우 D+7일 이후 폐기 예정 이오니 참고 부탁드립니다.*\n"
            f"\n"
            f"구성원 여러분들께서는 이점 숙지하시어 공용 냉장고 사용 부탁드립니다.\n"
            f":point_right: (Click) *<https://static.wixstatic.com/media/50072f_41299341619d417b9508c48964cb1e08~mv2.jpg|매주 금요일 냉장고 점검 안내>*\n"
            f"\n"
